 ...
 */
void UNS_InteractionPanel::NativeOnInitialized()
{
 ...
 */
void UNS_InteractionPanel::NativeConstruct()
{
 ...
 */
void UNS_InteractionPanel::UpdateWidget(const FInteractableData* InteractableData) const
{
 ...
 */
float UNS_InteractionPanel::UpdateInteractionProgress()
{
