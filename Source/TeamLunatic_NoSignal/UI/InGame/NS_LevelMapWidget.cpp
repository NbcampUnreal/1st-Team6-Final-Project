 ...
 *        블루프린트에서 호출 가능합니다.
 */
void UNS_LevelMapWidget::UpdatePlayerLocation(FVector2D NormalizedPosition)
{
 ...
 */
void UNS_LevelMapWidget::NativeConstruct()
{
 ...
 */
void UNS_LevelMapWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
